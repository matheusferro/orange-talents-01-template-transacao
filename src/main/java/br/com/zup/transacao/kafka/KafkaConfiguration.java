...
/**
 * Classe substituida por configuracao na propria
 * classe TransactionListener.
 */
@Deprecated
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, TransactionEvent> transactionConsumerFactory() {
        ...
        JsonDeserializer<TransactionEvent> jsonDeserialize = new JsonDeserializer<>(TransactionEvent.class, false);
